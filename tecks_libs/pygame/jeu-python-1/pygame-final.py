...
class Vaisseau(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.surf = pygame.image.load(root_path / "ressources/vaisseau.png").convert()
...
class Missile(pygame.sprite.Sprite):
    ...
    def __init__(self, center_missile):
        ...
        self.surf = pygame.image.load(root_path / "ressources/missile.png").convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
class Ennemi(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load(root_path / "ressources/ennemi.png").convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
class Explosion(pygame.sprite.Sprite):
    ...
    def __init__(self, center_vaisseau):
        ...
        self._compteur = 10
        self.surf = pygame.image.load(root_path / "ressources/explosion.png").convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
class Etoile(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load(root_path / "ressources/etoile.png").convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
pygame.mixer.init()
# Chargement des sons
son_missile = pygame.mixer.Sound(root_path / "ressources/laser.ogg")
son_explosion = pygame.mixer.Sound(root_path / "ressources/explosion.ogg")
