...
def main(page: Page):
    ...
    page.add(
        AppBar(
            bgcolor="lightblue",
            leading=IconButton(icon=icons.ARROW_BACK_IOS),
            title=Text("App Cleaner", color="white", weight="bold"),
            actions=[
                IconButton(
        ...
        Column(
            [
                ...
                # PROGRESSBAR SECTION
                Row([ProgressBar(width=300, value=0.4)], alignment="center"),
                # ICON INFO SECTION
                Row(
                    [
                        Container(
                ...
                Column(
                    [
                        Container(
                            ...
                            content=Text(
                                "can be Deleted", size=20, weight="bold", color="white"
                            ),
                        ),
                        # STACK CARD
                        Stack(
                            ...
                            [
                                Container(
                                    ...
                                    content=Row(
                                        [
                                            Icon(
                                                icons.TOUCH_APP, size=30, color="white"
                                            ),
                                            Text(
                                                "Optimize Now", color="white", size=30
                                            ),
                                        ]
                                    ),
                                )
